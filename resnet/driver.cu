...
main() {
    ...
    dim_t input_dim = {1000, element_size, 1, 1};
    ...
    std::cout << timer.get_step_seconds() << endl;
    host_vector<float> data_ans(1000);
...
// #pragma omp parallel for
        for(int j = 0; j < 1000; ++j) {
            float sum = 0;
            for(auto k: Range(element_size)) {
                sum += data_beg[j * element_size + k];
            }
            data_ans[j] = sum / element_size;
        }
    }
    std::cout << timer.get_step_seconds() << endl;
    ...
    //         train_acc += correct;
    //         train_count += 1;
    //         cout << loss / B << " " << correct << " " << train_acc / train_count << " "
    //         << endl; cout << "init_tm"
    //              << " " << init_tm << " "
    //              << "zero_tm"
    //              << " " << zero_tm << " "
    ...
    //         test_acc += correct;
    //         test_count += 1;
    //         cout << "test: " << loss / B << " " << test_acc / test_count << " " << t <<
    //         endl;
    //     }
    //     cout << endl;
    // }
